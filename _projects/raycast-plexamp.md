...
I already use Raycast for controlling everything else on my Mac, so I figured why not create an extension that lets me browse, search, and control Plexamp without leaving whatever I'm working on.
